...
////< DAFTAR BUTTON BY follow @cpm.goib > ////
...
`
 ...
 𝔍𝔞𝔫𝔤𝔞𝔫 𝔭𝔢𝔯𝔫𝔞𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔰𝔢𝔰??𝔬𝔯??𝔫𝔤 
  𝔶𝔞𝔫𝔤 𝔪𝔞𝔰𝔦𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔪𝔞𝔰𝔞𝔩??𝔩𝔲𝔫𝔶𝔞

 ♥️ FERDI`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
    ...
    reply(mess.wait)
     ...
     break
      case 'menu':
        case 'help':
        case 'daffa':  
        ikyy.sendMessage(from, soune, MessageType.audio, {quoted: btrai, mimetype: 'sound96/mp3', ptt:true})
               const boy = "6281217152804@s.whatsapp.net"     
               ...
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: '🗒️List Menu'},type:1},{buttonId:`${prefix}allmenu`,buttonText:{displayText:'📂ALLMENU'},type:1},{buttonId: `${prefix}pencarijodoh`,buttonText:{displayText: 'Pencari Jodoh'},type:1},{buttonId:`${prefix}allmenu`,buttonText:{displayText:'ALLMENU'},type:1}]
...
yang mau cari jodoh ketik !start ke pc botnya ya wkwkkw
...
"businessOwnerJid": "6281217152804@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
▹ ${prefix} wallgravity text1 text2
 `
sendButMessage(from, wibu, `Dibuat Oleh FERDI`, [
          {
...
`
   sendButMessage(from, wibu, `Dibuat Oleh FERDI`, [
        ...
        case 'simi':
              ...
              buttonsMessage = {footerText:'follow @cpm.goib', imageMessage: imageMsg,
...
▹ ${prefix} bokep2𝟓
 `
               ...
               sendButMessage(from, menu, `Dibuat Oleh FERDI`, [
          {
            buttonId: `${prefix}menu`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
`
   ...
   case 'command':
               list = []
               listmenu = [`groupmenu`,`pencarijodoh`,`soundmenu`,`photoxy`,`ephoto`,`randomimage`,`wibu2`,`storymenu`,`porno`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`ikyygroup`,`sewabot`]
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
   ...
   sendButMessage(from, titid, `Klik Untuk Ke Game Selanjutnya`, [
       ...
       case 'tebakanime':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebakchara?apikey=IkyChan`)
              get_result = get_result.result
   ...
   sendButMessage(from, titid, `Klik Untuk Ke Game Selanjutnya`, [
       ...
       case 'siapaaku':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/siapaaku?apikey=IkyChan`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
       ...
       case 'tebakkata':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/kata?apikey=IkyChan`)
              get_result = get_result.result
              jawaban = get_result.jawaban
       ...
       case 'tebaklirik':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/lirik?apikey=IkyChan`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
      ...
      case 'tebakjenaka':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/jenaka?apikey=IkyChan`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
       ...
       case 'kimiakuis':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/unsurkimia?apikey=IkyChan`)
              get_result = get_result.result
       ...
       case 'tebakbendera':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/bendera?apikey=IkyChan`)
              get_result = get_result.result
              jawaban = get_result.name
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
       ...
       case 'susunkata':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/susunkata?apikey=IkyChan`)
              get_result = get_result.result
              jawaban = get_result.jawaban
              pertanyaan = get_result.pertanyaan
       ...
       case 'asahotak':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/asahotak?apikey=IkyChan`)
              get_result = get_result.result
              jawaban = get_result.jawaban
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.pertanyaan
       ...
       case 'caklontong':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/caklontong2?apikey=IkyChan`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
...
Wa.me/6281217152804`
   sendButMessage(from, titid, `follow @cpm.goib `, [
          {
...
🐤 Character : ${get_info.characters.join(", ")}\n`
      ...
      case 'kusonime':
       ...
       case 'storyanime':
              ...
              reply(mess.wait)
              anu = await fetchJson(`https://lolhuman.herokuapp.com/api/storynime?apikey=IkyChan`)
...
//------------------< Level >-------------------
      case 'level': 
              ...
              buffer = await getBuffer(`https://lolhuman.herokuapp.com/api/rank?apikey=IkyChan&img=${profilePic}&background=https://telegra.ph/file/443b6600636aed1d94acd.jpg&username=${encodeURI(pushname)}&level=${userLevel}&ranking=${Number(userRank)}&currxp=${userXp}&xpneed=${requiredXp}`)
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/cpm.goib/`)
             break
      case 'ikyygroup':
             reply('https://chat.whatsapp.com/Gl7Qo3jt5Tr5yMFjmQ6LSV')
             break
