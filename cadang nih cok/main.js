...
const starts = async (ikyy = new WAConnection()) => {
	...
	console.log(color('[Scurity DEFF]', 'purple'), color('Owner is online now!', 'yellow'))

	console.log(color('[Scurity DEFF]', 'purple'), color('Welcome back, Owner! Hope you are doing well~', 'yellow'))
	...
	ikyy.on('connecting', () => {
		...
		console.log(color('[ DEFF ]', 'purple'), color('Menghubungkan....'));
	...
	ikyy.on('open', () => {
		...
		console.log(color('[DEFF ]', 'purple'), color('Bot Sudah Online!'));
